...
export default {
    install: function (Vue, options) {
         ...
         * @returns {boolean}
         */
        Vue.prototype.lengthCheck = (val, start, end) => {
         ...
         * @returns {boolean}
         */
        Vue.prototype.NumEnBothCheck = (val) => {
         ...
         * @returns {boolean}
         */
        Vue.prototype.notAllNumCheck = (val) => {
            let reg =  /^\w*[a-zA-Z]+\w*$/;
            return reg.test(val);
        };
        /**
