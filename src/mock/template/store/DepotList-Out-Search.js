...
const DepotList_Out_SearchUrl = $store.state.mock.url.DepotList_Out_SearchUrl;

const DepotList_Out_Search = {
    'success': true,
    'Depotdata': [
        {
            "data": {
...
/**
 * mockTest_DepotList_Out_Search
 * @param url
 * @param tem
 */
const mockTest_DepotList_Out_Search = function (url, tem) {
    Mock.mock(url, tem);
};

export {DepotList_Out_SearchUrl, DepotList_Out_Search, mockTest_DepotList_Out_Search}
