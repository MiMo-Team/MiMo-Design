...
const DepotList_InUrl = $store.state.mock.url.DepotList_InUrl;
...
/**
 * mockTest_DepotList_In
 * @param url
 * @param tem
 */
const mockTest_DepotList_In = function (url, tem) {
    Mock.mock(url, tem);
};

export {DepotList_InUrl, DepotList_In, mockTest_DepotList_In}
