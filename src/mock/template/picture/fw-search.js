...
const fashionWeekDataUrl = $store.state.mock.url.fashionWeekDataUrl;

const fashionWeekData = {
    'success': true,
    'picinfo': [{
        "data": {
            /* =====================  图片编号  =====================  */
...
/**
 * mockTest_fashionWeekData
 * @param url
 * @param tem
 */
const mockTest_fashionWeekData = function (url, tem) {
    Mock.mock(url, tem);
};

export {fashionWeekDataUrl, fashionWeekData, mockTest_fashionWeekData}
