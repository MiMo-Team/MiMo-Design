<template>
    <section class="todoapp">
        <!-- header -->
        <header class="header">
            <input class="new-todo" autofocus autocomplete="off" placeholder="工作安排计划" @keyup.enter="addTodo">
        </header>
        <!-- main section -->
        ...
        <footer class="footer" v-show="todos.length">
            <ul class="filters">
                <li class="todo-count"><strong>{{ remaining }}</strong>条剩余</li>
    ...
    export default {
        ...
        data() {
            return {
                visibility: 'all',
                filters,
                todos: JSON.parse(window.localStorage.getItem(STORAGE_KEY)) || this.todoList
            }
        },
        computed: {
            allChecked() {
...
<style lang="scss">
    @import '../../assets/css/Modular/todolist';
    ...
    .dashboard-admin-container .todoapp .main {
        max-height: 240px;
        overflow-y: auto;
    }
</style>
